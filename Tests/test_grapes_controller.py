...
from App.Controller.grapes_controller import GrapesController
...
class TestGrapesController(unittest.TestCase):
    def setUp(self):
        self.controller = GrapesController.__new__(GrapesController)
        self.controller.app_controller = MagicMock()
        self.controller.tick = MagicMock()  # Мок метода tick
    ...
    def test_start_growth_with_fertilizer(self):
        ...
        self.assertIsInstance(self.controller.model, GrapesModel)
